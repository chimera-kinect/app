...
//   if (baseSize > 30) blendMode(MULTIPLY);
...
//     //const baseSize = kinectManager.detectTouch()?.value
//    // baseSize = 100;
...
function init() {
  ...
  let scaledBaseSize = map(baseSize, 1, 255, 1, 100); // Scale to a range between 30 and 100
